    ...
    "56d7": function(e, t, r) {
        ...
        var n = r("2b0e"),
            ...
            l = function() {
                ...
                }, [r("ErrorModal"), r("Header"), r("router-view"), r("Footer")], 1)
            },
            d = [],
            m = (r("d3b7"), r("5530")),
            f = function() {
                ...
                return n("header", {
                ...
                }, [e._v(" Календарь ")])], 1), n("div", {
                    staticClass: "Search Header-Search"
                }, [e.searchIsOpen || e.windowWidth > 500 ? n("div", {
                    ...
                    on: {
                        click: e.onCloseSearch
                    }
                }, [n("use", {
                    attrs: {
                        "xlink:href": r("5754") + "#delete"
                    }
                })]) : e._e()]) : e._e(), e.searchIsOpen ? e._e() : n("svg", {
                ...
                })])]), e.isAuth ? n("UserSection") : n("router-link", {
            ...
            b = g,
            v = (r("0b0a"), r("2877")),
            j = Object(v["a"])(b, f, p, !1, null, null, null),
            w = j.exports,
            k = function() {
                var e = this,
                    t = e.$createElement,
                ...
                return r("div", {
                    ...
                    staticClass: "Wrapper Footer-Wrapper"
                }, [r("div", {
                ...
                }, [e._v(" " + e._s(e.email) + " ")])]), r("div", {
                    staticClass: "Footer-Item"
                }, [e._v(" (c) " + e._s(e.copyright) + ", " + e._s(e.copyrightFrom) + "-" + e._s((new Date).getFullYear()) + " ")])])])])
            },
            x = [],
            E = {
                name: "Footer",
                        ...
                        return Object(V["a"])(regeneratorRuntime.mark((function r() {
                            ...
                            return regeneratorRuntime.wrap((function(r) {
                                while (1) switch (r.prev = r.next) {
                                    ...
                                    case 6:
                                        c = r.sent, !1 === c.data.result ? n("setErrors", {
                                            message: "Логин и/или пароль введен(ы) неверно"
                                        }) : (n("clearAuthErrors"), n("login"), n("setUser", c.data.user)), r.next = 13;
                                        break;
                                    case 10:
                                        r.prev = 10, r.t0 = r["catch"](3), ae({
                                            commit: n,
                                            dispatch: a
                                        }, r.t0);
                                    case 13:
                    ...
                    restorePassword: function(e, t) {
                        return Object(V["a"])(regeneratorRuntime.mark((function r() {
                            ...
                            return regeneratorRuntime.wrap((function(r) {
                                while (1) switch (r.prev = r.next) {
                                    case 0:
                                        return n = e.commit, a = e.dispatch, s = t.email, r.prev = 2, r.next = 5, Z.a.post("".concat(ee["a"], "/api/auth/restore"), {
                                            email: s
                                        });
                                    case 5:
                                        o = r.sent, !1 === o.data.result ? n("setAuthErrors", {
                                            restoreError: "Логин не найден"
                                        }) : n("clearAuthErrors"), r.next = 12;
                                        break;
                                    case 9:
                                        r.prev = 9, r.t0 = r["catch"](2), ae({
                                            commit: n,
            ...
            oe = {
                ...
                actions: {
                    setHttpError: function(e, t) {
                        ...
                        if (t.response) {
                            var a = t.response;
                            404 === a.status ? (K.push("/404"), n = null) : 401 === a.status ? (K.push("/login"), n = null) : n = 400 === a.status && a.data.message ? {
                                message: a.data.message
                            } : 400 === a.status && a.data.errors ? a.data.errors : {
                                message: "Произошла ошибка на сервере с кодом ".concat(a.status, "! Пожалуйста, попробуйте позже или обратитесь к администратору")
                            }
                        } else n = {
                            message: "Связь с сервером потеряна! Пожалуйста, попробуйте позже или обратитесь к администратору"
                        };
                        n && r("setErrors", n)
                    },
                    handleResultFalseError: function(e, t) {
                        var r = e.commit;
                        !1 === t.result && (t.message ? r("setErrors", {
                            message: t.message
            ...
            e.upload = function() {
                var r = Object(n["a"])(regeneratorRuntime.mark((function r(n, a) {
                    ...
                    return regeneratorRuntime.wrap((function(r) {
                        while (1) switch (r.prev = r.next) {
                            case 0:
                                return r.prev = 0, s = new FormData, s.append("image", n.files[0]), r.next = 5, o.a.post(c.uploadUrl, s, {
                                    headers: {
